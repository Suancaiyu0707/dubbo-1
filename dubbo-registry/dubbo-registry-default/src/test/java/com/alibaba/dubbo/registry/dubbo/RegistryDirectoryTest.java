...
public class RegistryDirectoryTest {
    ...
    /***
     * 根据请求urL从注册中心目录下获得提供者列表
     * @param url
     * @return
     */
    //url=notsupported://10.20.30.40/com.alibaba.dubbo.registry.dubbo.RegistryDirectoryTest$DemoService?a=b&refer=foo%3Dbar
    ...
    private void test_Notified2invokers(RegistryDirectory registryDirectory) {
        ...
        //dubbo://127.0.0.1:9091/com.alibaba.dubbo.registry.dubbo.RegistryDirectoryTest$DemoService?lazy=true&side=consumer
        serviceUrls.add(SERVICEURL2.addParameter("methods", "getXXX1,getXXX2"));
        //dubbo://127.0.0.1:9092/com.alibaba.dubbo.registry.dubbo.RegistryDirectoryTest$DemoService?lazy=true&side=consumer
        serviceUrls.add(SERVICEURL2.addParameter("methods", "getXXX1,getXXX2"));
