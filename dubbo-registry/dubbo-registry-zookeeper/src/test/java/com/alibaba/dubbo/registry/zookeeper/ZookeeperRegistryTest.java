...
public class ZookeeperRegistryTest {
    ...
    public void testDefaultPort() {
        Assert.assertEquals("10.20.153.10:2181", com.alibaba.dubbo.registry.zookeeper.ZookeeperRegistry.appendDefaultPort("10.20.153.10:0"));
        Assert.assertEquals("10.20.153.10:2181", com.alibaba.dubbo.registry.zookeeper.ZookeeperRegistry.appendDefaultPort("10.20.153.10"));
    }
    ...
    public void testSubscribe() {
        ...
        registry.subscribe(service, new URL("dubbo", com.alibaba.dubbo.common.utils.NetUtils.getLocalHost(), 0, com.alibaba.dubbo.common.utils.StringUtils.parseQueryString(subscribearg)), new com.alibaba.dubbo.registry.NotifyListener() {
        ...
        assertEquals(serviceUrl.toParameterString(), com.alibaba.dubbo.common.utils.StringUtils.toQueryString(args.get()));
        Map<String, String> arg = registry.getSubscribed(service);
        assertEquals(subscribearg, com.alibaba.dubbo.common.utils.StringUtils.toQueryString(arg));
