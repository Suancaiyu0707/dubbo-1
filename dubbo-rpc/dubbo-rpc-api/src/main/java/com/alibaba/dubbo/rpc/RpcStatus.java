...
public class RpcStatus {
    ...
    /**
     * @param url 提供者地址
     * @param methodName 提供者暴露的方法
     * @return status 获取集群中某个提供者针对某方法的rpc请求状态
     */
    public static RpcStatus getStatus(URL url, String methodName) {
        String uri = url.toIdentityString();//注意，该方法在解析url的时候，只解析protocol、host、ip、service、username，跟参数无关
        //请求url的统计信息，返回一个map，每个提供者下的每个接口都对应一个map
        //METHOD_STATISTICS：{url&interface,{methodName,RpcStatus}}
        //map:{methodName,RpcStatus}
